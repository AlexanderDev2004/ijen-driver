...
<div class="w-full">
    ...
    <div class="bg-white rounded-lg shadow p-8">
        <h2 class="text-2xl font-bold text-slate-900 mb-6">Tambah Journal Baru</h2>
        ...
        <form action="{{ route('admin.journals.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <textarea id="content" name="content" required rows="8"
                          ...
                          placeholder="Tulis pengalaman dan cerita perjalanan Anda di sini...">{{ old('content') }}</textarea>
            ...
            <div>
                ...
                <p class="text-slate-500 text-sm mt-1">Format: JPEG, JPG, PNG, WEBP. Maksimal 5MB</p>
                @error('photo')
                <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div>
                ...
                <p class="text-slate-500 text-sm mt-1">Format: MP4, AVI, MOV, WMV, FLV. Maksimal 50MB</p>
                @error('video')
                <span class="text-red-600 text-sm mt-1 block">{{ $message }}</span>
                @enderror
            </div>
