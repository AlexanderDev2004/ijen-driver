...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
  <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-5 sm:p-7">
    <div class="mb-5 sm:mb-6">
      <h1 class="text-xl sm:text-2xl font-bold text-slate-900">{{ __('public.confirm_title') }}</h1>
    ...
    <div class="mt-5 sm:mt-6 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
      <a href="{{ route('booking.sendwa', $booking->id) }}" class="inline-flex items-center justify-center gap-2 bg-green-600 text-white px-5 py-3 rounded-xl font-semibold hover:bg-green-700 transition touch-manipulation">
      ...
      <a href="{{ route('tour.booking', $booking->tour) }}" class="inline-flex items-center justify-center bg-slate-200 text-slate-800 px-5 py-3 rounded-xl font-semibold hover:bg-slate-300 transition">
