...
<div class="max-w-5xl mx-auto bg-white rounded-xl shadow p-6">
  @if($tour->image)
    <img src="{{ asset('storage/'.$tour->image) }}" alt="{{ $tour->name }}" class="rounded-lg w-full h-80 object-cover mb-6">
  @endif
  ...
  <div class="flex items-center justify-between mt-6">
    ...
    <a href="{{ route('tour.booking', $tour) }}" class="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-lg font-medium">
      Booking Sekarang
    </a>
  </div>
</div>
